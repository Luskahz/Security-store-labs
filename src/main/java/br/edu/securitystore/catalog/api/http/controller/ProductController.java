package br.edu.securitystore.catalog.api.http.controller;
import br.edu.securitystore.catalog.core.application.CatalogService; import br.edu.securitystore.catalog.api.http.dto.response.ProductResponse; import jakarta.validation.Valid; import jakarta.validation.constraints.*; import java.math.BigDecimal; import java.util.List; import org.springframework.http.*; import org.springframework.web.bind.annotation.*;
